<script lang="ts">
	...
	// ! Note: Google TTS is only able to speak limited. For e.g, in below story it can only speak that much - "In a small village ... She lay in bed all day, staring out"
	let shortStory = `
