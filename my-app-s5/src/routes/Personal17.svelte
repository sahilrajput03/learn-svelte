<script lang="ts">
	...
	// ❤️ Example from here: https://bits-ui.com/docs/components/select

	// 👉🏻 What is `phosphor-svelte` ?
	//  > Phosphor is a flexible icon family for interfaces, diagrams,
	//      presentations — whatever, really. More icons at
	//      phosphoricons.com. Install via: npm i -D phosphor-svelte
	// 	Github: https://github.com/haruaki07/phosphor-svelte
